...
अपने स्वयं के प्रॉक्सी का निर्माण करने के लिए नेटवर्क प्रतिबंधों को बायपास करने के लिए v2ray को आसानी से तैनात करने के लिए fhs-install-v2ray इंस्टॉलेशन स्क्रिप्ट का उपयोग किया जाता है
...
1.  GHHub.com से ज़िप फ़ाइल के रूप में fhs-install-v2ray रिपॉजिटरी डाउनलोड करें।
...
-   यदि आधिकारिक छवि आपके कस्टम इंस्टॉलेशन की जरूरतों को पूरा नहीं कर सकती है, तो कृपया प्राप्त करने के लिए अपस्ट्रीम डॉकफाइल को पुन: पेश और संशोधित करें
...
-   कृपया स्थापना के बाद देखें[फ़ाइल](https://www.v2fly.org/)कॉन्फ़िगरेशन फ़ाइल सिंटैक्स को समझें, और अपने लिए उपयुक्त कॉन्फ़िगरेशन फ़ाइल को पूरा करें। आप प्रक्रिया के दौरान सामुदायिक योगदान का उल्लेख कर सकते हैं[कॉन्फ़िगरेशन प्रोफ़ाइल टेम्पलेट](https://github.com/v2fly/v2ray-examples)
...
**कृपया प्रश्न पूछने से पहले पढ़ें[अंक # 63](https://github.com/v2fly/fhs-install-v2ray/issues/63), अन्यथा इसका जवाब नहीं दिया जा सकता है और लॉक किया जा सकता है।**

## योगदान

कृप्या[विकसित करें](https://github.com/v2fly/fhs-install-v2ray/tree/develop)मुख्य शाखा को नुकसान से बचने के लिए शाखा।
